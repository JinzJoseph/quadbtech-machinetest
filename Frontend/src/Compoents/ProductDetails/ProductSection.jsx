    ...
    <>
      <div className="container mx-auto pt-5 flex w-full h-auto bg-white">
        ...
        <div className="w-[60%] ml-8 flex flex-col">
          ...
          <h1 className="text-4xl mt-4 font-semibold">Tray Table</h1>
          <p className="mt-2 text-gray-600">
            Buy one or a few and make every space where you sit more convenient. Light
            and easy to move around with removable tray top, handy for serving
            snacks.
          </p>
          <div className="flex items-center mt-3">
            <h1 className="font-bold text-black text-2xl">$199.00</h1>
            <p className="text-slate-400 line-through ml-3">$400.00</p>
          </div>
          ...
          <div className="flex gap-2 mt-4 ">
            {[...Array(3)].map((_, index) => (
              <div key={index} className="bg-slate-400 p-1 m-auto justify-between">
                <img
          ...
          <div className="mt-4">
            ...
            <div className="flex justify-between items-center mt-4">
              ...
              <p className="text-xl">Living Room, Bedroom</p>
            </div>
          </div>
          <div className="mt-4">
            ...
            <h4 className="text-slate-400 text-xl mt-4 font-semibold">Details</h4>
            <p className="text-black mt-3 tracking-wide">
              You can see the removable tray for serving. The design makes it easy
              to put the tray back after use since you place it directly on the
              table frame without having to fit it into any holes.
            </p>
            <h2 className="font-semibold text-slate-400 my-4 text-xl">Packaging</h2>
